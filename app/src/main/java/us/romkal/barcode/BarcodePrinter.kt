  ...
  suspend fun printPdf(
    ...
    return withContext(Dispatchers.IO) {
      ...
      drawTextBlock(
        ...
        *strengthDescription(R.string.strong_strength, alcohols.mapValues { it.value * 1.7f }, water),
        *strengthDescription(R.string.light_strength, alcohols.mapValues { it.value * 0.7f }, water),
